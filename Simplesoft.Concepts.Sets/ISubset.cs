...
namespace Simplesoft.Concepts.Sets
{
	...
	public interface ISubset<T>
	{
		...
		public delegate void ClearEventResponder(ISubset<T> subset, long count);
		/// <summary>
		...
		public delegate void RemoveEventResponder(ISubset<T> subset, T element, long address);
		/// <summary>
		...
		/// <param name="address">The address of <paramref name="element"/> in the <see cref="ISubset{T}"/>.</param>
		public delegate void AddEventResponder(ISubset<T> subset, T element, long address);
		...
		{
			/// <summary>
			/// Provides exceptions for <see cref="TryAdd(T, out long)"/> method.
			/// </summary>
			...
			bool TryRemoveAt(long address, out T element);
			/// <summary>
			...
			bool TryRemove(T element, out long address);
			/// <summary>
			...
			bool TryAdd(T element, out long address);
		}
		...
		bool TryGetAddress(T element, out long address);
		/// <summary>
		...
		bool TryGetAt(long address, out T element);
	}
}